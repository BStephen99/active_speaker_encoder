...
if __name__ == '__main__':
    ...
    if mode == "ava_train":
        video_path = os.path.join(io_config['ava_video_dir'], 'train')
        audio_path = os.path.join(io_config['ava_audio_dir'], 'train')
        csv_path = io_config['ava_csv_train_full']

    elif mode == "ava_val":
        video_path = os.path.join(io_config['ava_video_dir'], 'val')
        audio_path = os.path.join(io_config['ava_audio_dir'], 'val')
        csv_path = io_config['ava_csv_val_full']

    elif mode == "pepper_back":
        video_path = os.path.join(io_config['video_dir'], 'back')
        audio_path = os.path.join(io_config['audio_dir'], 'back')
        csv_path = io_config['csv_train_full']

    elif mode == "pepper_high":
        video_path = os.path.join(io_config['video_dir'], 'high')
        audio_path = os.path.join(io_config['audio_dir'], 'high')
        csv_path = io_config['csv_train_full']

    elif mode == "wasd_train":
        video_path = os.path.join(io_config['wasd_video_dir'], 'train')
        audio_path = os.path.join(io_config['wasd_audio_dir'], 'train')
        csv_path = io_config['wasd_csv_train_full']

    elif mode == "wasd_val":
        video_path = os.path.join(io_config['wasd_video_dir'], 'val')
        audio_path = os.path.join(io_config['wasd_audio_dir'], 'val')
        csv_path = io_config['wasd_csv_val_full']
    ...
    for video_key in val_videos[:]:
        ...
        with open(target_directory+video_key+'.csv', mode='w') as vf:
            ...
            d_val = AudioVideoDatasetAuxLossesForwardPhase(video_key, audio_path, video_path,
